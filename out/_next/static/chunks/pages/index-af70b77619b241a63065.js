                ...
                switch (r.type) {
                  case 'graphdata':
                    return (function (e) {
                      ...
                      var t = [].concat((0, s.Z)(e.links), (0, s.Z)(r))
          ...
          Z = (0, d.useMemo)(
            function () {
              var e = t.nodes.filter(function (e) {
                ...
                r = t.links.filter(function (e) {
                  var r = e
                  return (
                    'cite' !== r.type &&
                    (h.parents || 'parent' !== r.type) &&
                    n.includes(r.source) &&
                    n.includes(r.target)
                  )
                }),
                ...
                l = r.filter(function (e) {
                  ...
                  return o.includes(n) && o.includes(r)
                })
              return 0 === v.nodeIds.length ? { nodes: e, links: r } : { nodes: i, links: l }
            },
            [h, v, t],
          )
        ;(0, d.useEffect)(function () {
